module.exports = (sequelize, DataTypes) => {
  ...
  Users.getOwnedParentRestaurants = async function (userId, models) {
    try {
  ...
  Users.getStoreAdminRestaurantHierarchy = async function (userId, models) {
    try {
      /* ---------------- GET ROLE ---------------- */
  ...
  Users.associate = (models) => {
    ...
    // Modules relations
    Users.hasMany(models.modules, { foreignKey: 'created_by', as: 'createdModules' });
    Users.hasMany(models.modules, { foreignKey: 'updated_by', as: 'updatedModules' });
    Users.hasMany(models.modules, { foreignKey: 'deleted_by', as: 'deletedModules' });

    // UserPermissions relations
    Users.hasMany(models.user_permissions, { foreignKey: 'user_id', as: 'userPermissions' });
    Users.hasMany(models.user_permissions, { foreignKey: 'assigned_by', as: 'userPermissionsAssignedBy' });

    // UserRoles relations
    Users.hasMany(models.user_roles, { foreignKey: 'user_id', as: 'userRoles' });
    Users.hasMany(models.user_roles, { foreignKey: 'assigned_by', as: 'userRolesAssignedBy' });

    // RolePermissions relations
    Users.hasMany(models.role_permissions, { foreignKey: 'assigned_by', as: 'rolePermissionsAssignedBy' });

    // User Device realations
    Users.hasMany(models.user_devices, { foreignKey: 'user_id', as: 'devices' });
